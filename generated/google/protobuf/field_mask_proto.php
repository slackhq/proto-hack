...
class FieldMask implements \Protobuf\Message {
  ...
  public function setFields(FieldMaskFields $s = shape()): void {
    if (Shapes::keyExists($s, 'paths')) $this->paths = $s['paths'];
  }

  public function getNonDefaultFields(): FieldMaskFields {
    $s = shape();
    if (!C\is_empty($this->paths)) $s['paths'] = $this->paths;
    return $s;
  }
