...
class Version implements \Protobuf\Message {
  ...
  public function setFields(VersionFields $s = shape()): void {
    if (Shapes::keyExists($s, 'major')) $this->major = $s['major'];
    if (Shapes::keyExists($s, 'minor')) $this->minor = $s['minor'];
    if (Shapes::keyExists($s, 'patch')) $this->patch = $s['patch'];
    if (Shapes::keyExists($s, 'suffix')) $this->suffix = $s['suffix'];
  }

  public function getNonDefaultFields(): VersionFields {
    $s = shape();
    if ($this->major !== 0) $s['major'] = $this->major;
    if ($this->minor !== 0) $s['minor'] = $this->minor;
    if ($this->patch !== 0) $s['patch'] = $this->patch;
    if ($this->suffix !== '') $s['suffix'] = $this->suffix;
    return $s;
  }
...
type CodeGeneratorRequestFields = shape (
...
class CodeGeneratorRequest implements \Protobuf\Message {
  ...
  public function setFields(CodeGeneratorRequestFields $s = shape()): void {
  ...
  public function getNonDefaultFields(): CodeGeneratorRequestFields {
    $s = shape();
...
type CodeGeneratorResponse_FileFields = shape (
  ?'name' => string,
...
class CodeGeneratorResponse_File implements \Protobuf\Message {
  ...
  public function setFields(CodeGeneratorResponse_FileFields $s = shape()): void {
    if (Shapes::keyExists($s, 'name')) $this->name = $s['name'];
    if (Shapes::keyExists($s, 'insertion_point')) $this->insertion_point = $s['insertion_point'];
  ...
  public function getNonDefaultFields(): CodeGeneratorResponse_FileFields {
    $s = shape();
...
type CodeGeneratorResponseFields = shape (
  ?'error' => string,
  ?'supported_features' => int,
  ?'file' => vec<\google\protobuf\compiler\CodeGeneratorResponse_FileFields>,
);
class CodeGeneratorResponse implements \Protobuf\Message {
  ...
  public function setFields(CodeGeneratorResponseFields $s = shape()): void {
  ...
  public function getNonDefaultFields(): CodeGeneratorResponseFields {
    $s = shape();
