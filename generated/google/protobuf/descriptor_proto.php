...
type FileDescriptorSetFields = shape (
  ?'file' => vec<\google\protobuf\FileDescriptorProtoFields>,
);
...
type FileDescriptorProtoFields = shape (
  ?'name' => string,
  ?'package' => string,
  ?'dependency' => vec<string>,
  ?'public_dependency' => vec<int>,
  ?'weak_dependency' => vec<int>,
  ?'message_type' => vec<\google\protobuf\DescriptorProtoFields>,
...
class FileDescriptorProto implements \Protobuf\Message {
  ...
  public function setFields(FileDescriptorProtoFields $s = shape()): void {
    if (Shapes::keyExists($s, 'name')) $this->name = $s['name'];
    if (Shapes::keyExists($s, 'package')) $this->package = $s['package'];
    if (Shapes::keyExists($s, 'dependency')) $this->dependency = $s['dependency'];
  ...
  public function getNonDefaultFields(): FileDescriptorProtoFields {
    $s = shape();
    if ($this->name !== '') $s['name'] = $this->name;
    if ($this->package !== '') $s['package'] = $this->package;
...
class DescriptorProto_ExtensionRange implements \Protobuf\Message {
  ...
  public function setFields(DescriptorProto_ExtensionRangeFields $s = shape()): void {
    if (Shapes::keyExists($s, 'start')) $this->start = $s['start'];
  ...
  public function getNonDefaultFields(): DescriptorProto_ExtensionRangeFields {
    $s = shape();
...
type DescriptorProto_ReservedRangeFields = shape (
  ?'start' => int,
  ?'end' => int,
);
class DescriptorProto_ReservedRange implements \Protobuf\Message {
  ...
  public function setFields(DescriptorProto_ReservedRangeFields $s = shape()): void {
    if (Shapes::keyExists($s, 'start')) $this->start = $s['start'];
    if (Shapes::keyExists($s, 'end')) $this->end = $s['end'];
  }

  public function getNonDefaultFields(): DescriptorProto_ReservedRangeFields {
    $s = shape();
    if ($this->start !== 0) $s['start'] = $this->start;
    if ($this->end !== 0) $s['end'] = $this->end;
    return $s;
...
type DescriptorProtoFields = shape (
  ?'name' => string,
  ?'field' => vec<\google\protobuf\FieldDescriptorProtoFields>,
  ?'extension' => vec<\google\protobuf\FieldDescriptorProtoFields>,
  ?'nested_type' => vec<\google\protobuf\DescriptorProtoFields>,
  ?'enum_type' => vec<\google\protobuf\EnumDescriptorProtoFields>,
...
type ExtensionRangeOptionsFields = shape (
  ?'uninterpreted_option' => vec<\google\protobuf\UninterpretedOptionFields>,
);
...
type FieldDescriptorProtoFields = shape (
  ?'name' => string,
  ?'number' => int,
...
class FieldDescriptorProto implements \Protobuf\Message {
  ...
  public function setFields(FieldDescriptorProtoFields $s = shape()): void {
    if (Shapes::keyExists($s, 'name')) $this->name = $s['name'];
    if (Shapes::keyExists($s, 'number')) $this->number = $s['number'];
    if (Shapes::keyExists($s, 'label')) $this->label = $s['label'];
    if (Shapes::keyExists($s, 'type')) $this->type = $s['type'];
    if (Shapes::keyExists($s, 'type_name')) $this->type_name = $s['type_name'];
    if (Shapes::keyExists($s, 'extendee')) $this->extendee = $s['extendee'];
  ...
  public function getNonDefaultFields(): FieldDescriptorProtoFields {
    $s = shape();
    if ($this->name !== '') $s['name'] = $this->name;
    if ($this->number !== 0) $s['number'] = $this->number;
    if ($this->label !== \google\protobuf\FieldDescriptorProto_Label::FromInt(0)) $s['label'] = $this->label;
    if ($this->type !== \google\protobuf\FieldDescriptorProto_Type::FromInt(0)) $s['type'] = $this->type;
    if ($this->type_name !== '') $s['type_name'] = $this->type_name;
    if ($this->extendee !== '') $s['extendee'] = $this->extendee;
...
class OneofDescriptorProto implements \Protobuf\Message {
  ...
  public function setFields(OneofDescriptorProtoFields $s = shape()): void {
    if (Shapes::keyExists($s, 'name')) $this->name = $s['name'];
    if (Shapes::keyExists($s, 'options')) {
...
type EnumDescriptorProto_EnumReservedRangeFields = shape (
  ?'start' => int,
  ?'end' => int,
);
class EnumDescriptorProto_EnumReservedRange implements \Protobuf\Message {
  ...
  public function setFields(EnumDescriptorProto_EnumReservedRangeFields $s = shape()): void {
    if (Shapes::keyExists($s, 'start')) $this->start = $s['start'];
    if (Shapes::keyExists($s, 'end')) $this->end = $s['end'];
  }

  public function getNonDefaultFields(): EnumDescriptorProto_EnumReservedRangeFields {
    $s = shape();
    if ($this->start !== 0) $s['start'] = $this->start;
    if ($this->end !== 0) $s['end'] = $this->end;
    return $s;
...
class EnumValueDescriptorProto implements \Protobuf\Message {
  ...
  public function setFields(EnumValueDescriptorProtoFields $s = shape()): void {
    if (Shapes::keyExists($s, 'name')) $this->name = $s['name'];
    if (Shapes::keyExists($s, 'number')) $this->number = $s['number'];
    if (Shapes::keyExists($s, 'options')) {
  ...
  public function getNonDefaultFields(): EnumValueDescriptorProtoFields {
    $s = shape();
    if ($this->name !== '') $s['name'] = $this->name;
    if ($this->number !== 0) $s['number'] = $this->number;
    return $s;
...
type MethodDescriptorProtoFields = shape (
  ?'name' => string,
  ?'input_type' => string,
  ?'output_type' => string,
...
class MethodDescriptorProto implements \Protobuf\Message {
  ...
  public function setFields(MethodDescriptorProtoFields $s = shape()): void {
    if (Shapes::keyExists($s, 'name')) $this->name = $s['name'];
    if (Shapes::keyExists($s, 'input_type')) $this->input_type = $s['input_type'];
  ...
  public function getNonDefaultFields(): MethodDescriptorProtoFields {
    $s = shape();
    if ($this->name !== '') $s['name'] = $this->name;
...
class FileOptions implements \Protobuf\Message {
  ...
  public function setFields(FileOptionsFields $s = shape()): void {
    if (Shapes::keyExists($s, 'java_package')) $this->java_package = $s['java_package'];
    if (Shapes::keyExists($s, 'java_outer_classname')) $this->java_outer_classname = $s['java_outer_classname'];
    if (Shapes::keyExists($s, 'java_multiple_files')) $this->java_multiple_files = $s['java_multiple_files'];
    if (Shapes::keyExists($s, 'java_generate_equals_and_hash')) $this->java_generate_equals_and_hash = $s['java_generate_equals_and_hash'];
    if (Shapes::keyExists($s, 'java_string_check_utf8')) $this->java_string_check_utf8 = $s['java_string_check_utf8'];
    if (Shapes::keyExists($s, 'optimize_for')) $this->optimize_for = $s['optimize_for'];
    if (Shapes::keyExists($s, 'go_package')) $this->go_package = $s['go_package'];
    if (Shapes::keyExists($s, 'cc_generic_services')) $this->cc_generic_services = $s['cc_generic_services'];
    if (Shapes::keyExists($s, 'java_generic_services')) $this->java_generic_services = $s['java_generic_services'];
    if (Shapes::keyExists($s, 'py_generic_services')) $this->py_generic_services = $s['py_generic_services'];
    if (Shapes::keyExists($s, 'php_generic_services')) $this->php_generic_services = $s['php_generic_services'];
    if (Shapes::keyExists($s, 'deprecated')) $this->deprecated = $s['deprecated'];
    if (Shapes::keyExists($s, 'cc_enable_arenas')) $this->cc_enable_arenas = $s['cc_enable_arenas'];
    if (Shapes::keyExists($s, 'objc_class_prefix')) $this->objc_class_prefix = $s['objc_class_prefix'];
    if (Shapes::keyExists($s, 'csharp_namespace')) $this->csharp_namespace = $s['csharp_namespace'];
    if (Shapes::keyExists($s, 'swift_prefix')) $this->swift_prefix = $s['swift_prefix'];
    if (Shapes::keyExists($s, 'php_class_prefix')) $this->php_class_prefix = $s['php_class_prefix'];
    if (Shapes::keyExists($s, 'php_namespace')) $this->php_namespace = $s['php_namespace'];
  ...
  public function getNonDefaultFields(): FileOptionsFields {
    $s = shape();
    if ($this->java_package !== '') $s['java_package'] = $this->java_package;
    if ($this->java_outer_classname !== '') $s['java_outer_classname'] = $this->java_outer_classname;
    if ($this->java_multiple_files !== false) $s['java_multiple_files'] = $this->java_multiple_files;
    if ($this->java_generate_equals_and_hash !== false) $s['java_generate_equals_and_hash'] = $this->java_generate_equals_and_hash;
    if ($this->java_string_check_utf8 !== false) $s['java_string_check_utf8'] = $this->java_string_check_utf8;
    if ($this->optimize_for !== \google\protobuf\FileOptions_OptimizeMode::FromInt(0)) $s['optimize_for'] = $this->optimize_for;
    if ($this->go_package !== '') $s['go_package'] = $this->go_package;
    if ($this->cc_generic_services !== false) $s['cc_generic_services'] = $this->cc_generic_services;
    if ($this->java_generic_services !== false) $s['java_generic_services'] = $this->java_generic_services;
    if ($this->py_generic_services !== false) $s['py_generic_services'] = $this->py_generic_services;
    if ($this->php_generic_services !== false) $s['php_generic_services'] = $this->php_generic_services;
    if ($this->deprecated !== false) $s['deprecated'] = $this->deprecated;
    if ($this->cc_enable_arenas !== false) $s['cc_enable_arenas'] = $this->cc_enable_arenas;
    if ($this->objc_class_prefix !== '') $s['objc_class_prefix'] = $this->objc_class_prefix;
    if ($this->csharp_namespace !== '') $s['csharp_namespace'] = $this->csharp_namespace;
    if ($this->swift_prefix !== '') $s['swift_prefix'] = $this->swift_prefix;
    if ($this->php_class_prefix !== '') $s['php_class_prefix'] = $this->php_class_prefix;
...
type MessageOptionsFields = shape (
...
class MessageOptions implements \Protobuf\Message {
  ...
  public function setFields(MessageOptionsFields $s = shape()): void {
    if (Shapes::keyExists($s, 'message_set_wire_format')) $this->message_set_wire_format = $s['message_set_wire_format'];
    if (Shapes::keyExists($s, 'no_standard_descriptor_accessor')) $this->no_standard_descriptor_accessor = $s['no_standard_descriptor_accessor'];
    if (Shapes::keyExists($s, 'deprecated')) $this->deprecated = $s['deprecated'];
  ...
  public function getNonDefaultFields(): MessageOptionsFields {
    $s = shape();
    if ($this->message_set_wire_format !== false) $s['message_set_wire_format'] = $this->message_set_wire_format;
...
class FieldOptions implements \Protobuf\Message {
  ...
  public function setFields(FieldOptionsFields $s = shape()): void {
    if (Shapes::keyExists($s, 'ctype')) $this->ctype = $s['ctype'];
    if (Shapes::keyExists($s, 'packed')) $this->packed = $s['packed'];
    if (Shapes::keyExists($s, 'jstype')) $this->jstype = $s['jstype'];
    if (Shapes::keyExists($s, 'lazy')) $this->lazy = $s['lazy'];
    if (Shapes::keyExists($s, 'deprecated')) $this->deprecated = $s['deprecated'];
  ...
  public function getNonDefaultFields(): FieldOptionsFields {
    $s = shape();
    if ($this->ctype !== \google\protobuf\FieldOptions_CType::FromInt(0)) $s['ctype'] = $this->ctype;
    if ($this->packed !== false) $s['packed'] = $this->packed;
    if ($this->jstype !== \google\protobuf\FieldOptions_JSType::FromInt(0)) $s['jstype'] = $this->jstype;
...
class EnumOptions implements \Protobuf\Message {
  ...
  public function setFields(EnumOptionsFields $s = shape()): void {
  ...
  public function getNonDefaultFields(): EnumOptionsFields {
    $s = shape();
...
type EnumValueOptionsFields = shape (
  ?'deprecated' => bool,
  ?'uninterpreted_option' => vec<\google\protobuf\UninterpretedOptionFields>,
);
...
type ServiceOptionsFields = shape (
  ?'deprecated' => bool,
  ?'uninterpreted_option' => vec<\google\protobuf\UninterpretedOptionFields>,
);
...
type MethodOptionsFields = shape (
  ?'deprecated' => bool,
...
class MethodOptions implements \Protobuf\Message {
  ...
  public function setFields(MethodOptionsFields $s = shape()): void {
    if (Shapes::keyExists($s, 'deprecated')) $this->deprecated = $s['deprecated'];
  ...
  public function getNonDefaultFields(): MethodOptionsFields {
    $s = shape();
    if ($this->deprecated !== false) $s['deprecated'] = $this->deprecated;
...
type UninterpretedOption_NamePartFields = shape (
  ?'name_part' => string,
  ?'is_extension' => bool,
);
class UninterpretedOption_NamePart implements \Protobuf\Message {
  ...
  public function setFields(UninterpretedOption_NamePartFields $s = shape()): void {
    if (Shapes::keyExists($s, 'name_part')) $this->name_part = $s['name_part'];
    if (Shapes::keyExists($s, 'is_extension')) $this->is_extension = $s['is_extension'];
  }

  public function getNonDefaultFields(): UninterpretedOption_NamePartFields {
    $s = shape();
    if ($this->name_part !== '') $s['name_part'] = $this->name_part;
    if ($this->is_extension !== false) $s['is_extension'] = $this->is_extension;
    return $s;
  }
...
type UninterpretedOptionFields = shape (
  ?'name' => vec<\google\protobuf\UninterpretedOption_NamePartFields>,
...
class UninterpretedOption implements \Protobuf\Message {
  ...
  public function setFields(UninterpretedOptionFields $s = shape()): void {
    ...
    if (Shapes::keyExists($s, 'negative_int_value')) $this->negative_int_value = $s['negative_int_value'];
    if (Shapes::keyExists($s, 'double_value')) $this->double_value = $s['double_value'];
    if (Shapes::keyExists($s, 'string_value')) $this->string_value = $s['string_value'];
    if (Shapes::keyExists($s, 'aggregate_value')) $this->aggregate_value = $s['aggregate_value'];
  }
  ...
  public function getNonDefaultFields(): UninterpretedOptionFields {
    ...
    if ($this->double_value !== 0.0) $s['double_value'] = $this->double_value;
    if ($this->string_value !== '') $s['string_value'] = $this->string_value;
    if ($this->aggregate_value !== '') $s['aggregate_value'] = $this->aggregate_value;
    return $s;
  }
...
type SourceCodeInfo_LocationFields = shape (
  ?'path' => vec<int>,
  ?'span' => vec<int>,
...
class SourceCodeInfo_Location implements \Protobuf\Message {
  ...
  public function setFields(SourceCodeInfo_LocationFields $s = shape()): void {
    if (Shapes::keyExists($s, 'path')) $this->path = $s['path'];
    if (Shapes::keyExists($s, 'span')) $this->span = $s['span'];
    if (Shapes::keyExists($s, 'leading_comments')) $this->leading_comments = $s['leading_comments'];
    if (Shapes::keyExists($s, 'trailing_comments')) $this->trailing_comments = $s['trailing_comments'];
    if (Shapes::keyExists($s, 'leading_detached_comments')) $this->leading_detached_comments = $s['leading_detached_comments'];
  }

  public function getNonDefaultFields(): SourceCodeInfo_LocationFields {
    $s = shape();
    if (!C\is_empty($this->path)) $s['path'] = $this->path;
    if (!C\is_empty($this->span)) $s['span'] = $this->span;
    if ($this->leading_comments !== '') $s['leading_comments'] = $this->leading_comments;
    if ($this->trailing_comments !== '') $s['trailing_comments'] = $this->trailing_comments;
    if (!C\is_empty($this->leading_detached_comments)) $s['leading_detached_comments'] = $this->leading_detached_comments;
    return $s;
  }
...
type SourceCodeInfoFields = shape (
  ?'location' => vec<\google\protobuf\SourceCodeInfo_LocationFields>,
);
...
type GeneratedCodeInfo_AnnotationFields = shape (
  ?'path' => vec<int>,
  ?'source_file' => string,
  ?'begin' => int,
  ?'end' => int,
...
class GeneratedCodeInfo_Annotation implements \Protobuf\Message {
  ...
  public function setFields(GeneratedCodeInfo_AnnotationFields $s = shape()): void {
    if (Shapes::keyExists($s, 'path')) $this->path = $s['path'];
    if (Shapes::keyExists($s, 'source_file')) $this->source_file = $s['source_file'];
    if (Shapes::keyExists($s, 'begin')) $this->begin = $s['begin'];
    if (Shapes::keyExists($s, 'end')) $this->end = $s['end'];
  }

  public function getNonDefaultFields(): GeneratedCodeInfo_AnnotationFields {
    $s = shape();
    if (!C\is_empty($this->path)) $s['path'] = $this->path;
    if ($this->source_file !== '') $s['source_file'] = $this->source_file;
    if ($this->begin !== 0) $s['begin'] = $this->begin;
    if ($this->end !== 0) $s['end'] = $this->end;
    return $s;
  }
...
type GeneratedCodeInfoFields = shape (
  ?'annotation' => vec<\google\protobuf\GeneratedCodeInfo_AnnotationFields>,
);
