...
class Donkey implements \Protobuf\Message {
  ...
  public function setFields(DonkeyFields $s = shape()): void {
    if (Shapes::keyExists($s, 'hi')) $this->hi = $s['hi'];
  }

  public function getNonDefaultFields(): DonkeyFields {
    $s = shape();
    if ($this->hi !== '') $s['hi'] = $this->hi;
    return $s;
  }
...
class Funky_Monkey implements \Protobuf\Message {
  ...
  public function setFields(Funky_MonkeyFields $s = shape()): void {
    if (Shapes::keyExists($s, 'hi')) $this->hi = $s['hi'];
  }

  public function getNonDefaultFields(): Funky_MonkeyFields {
    $s = shape();
    if ($this->hi !== '') $s['hi'] = $this->hi;
    return $s;
  }
